  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-6 sm:p-7">
        <span className="min-h-[3.5rem] line-clamp-2 text-lg font-semibold leading-snug text-blue-950 group-hover:text-blue-700">
          {toTitleCase(category.name)}
        </span>
        <span className="mt-2 line-clamp-3 flex-1 text-sm leading-relaxed text-blue-900/70">
          {cardDescription(category)}
        </span>
        <span className="mt-4 inline-flex items-center text-sm font-semibold text-sky-700 group-hover:text-blue-700">
          Learn more
          <span
