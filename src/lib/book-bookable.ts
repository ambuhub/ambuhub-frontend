...
import { listingPricingPeriod } from "@/lib/pricing-period";
...
export function effectiveBookPricingPeriod(
  svc: MarketplaceServiceRow,
): ReturnType<typeof listingPricingPeriod> {
  return listingPricingPeriod(svc.pricingPeriod);
}
